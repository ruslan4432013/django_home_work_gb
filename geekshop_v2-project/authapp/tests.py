...
class TestUserManagement(TestCase):
   def setUp(self):
       ...
       self.user = ShopUser.objects.create_user('Petaya', 'petya@geekshop.local', 'geekbrains')

       self.user_with__first_name = ShopUser.objects.create_user('vasya',
                                                                 'vasya@geekshop.local',
                                                                 'geekbrains', first_name='vasya')
   ...
   def test_user_login(self):
       ...
       # данные пользователя
       self.client.login(username='Petaya', password='geekbrains')
