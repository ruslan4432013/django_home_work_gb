window.onload = function () {
    ...
    $('.formset_row').formset({
        addText: 'РґРѕР±Р°РІРёС‚СЊ РїСЂРѕРґСѓРєС‚',
        deleteText: 'СѓРґР°Р»РёС‚СЊ',
        prefix: 'orderitems',
                ...
                success: function (data) {
                    if (data.price) {
                        ...
                        let price_html = '<span class="orderitems-' + orderitem_num + '-price">'
                            + data.price.toString().replace('.', ',') + '</span> СЂСѓР±';
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    alert('С‚РѕРІР°СЂ РґРѕР±Р°РІР»РµРЅ РІС‹ РєРѕСЂР·РёРЅСѓ')
                },
            });
        event.preventDefault()
    })
